...
{<img src="https://travis-ci.org/jeremyolliver/cadence.png?branch=master" alt="Build Status" />}[https://travis-ci.org/jeremyolliver/cadence]
{<img src="https://coveralls.io/repos/jeremyolliver/cadence/badge.png?branch=master" alt="Coverage Status" />}[https://coveralls.io/r/jeremyolliver/cadence?branch=master]
{<img src="https://codeclimate.com/github/jeremyolliver/cadence.png" />}[https://codeclimate.com/github/jeremyolliver/cadence]
